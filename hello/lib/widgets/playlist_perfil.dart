                       ...
                       if(existe==true){
                        ...
                        showDialog(
                           ...
                           builder: (_) => AlertDialog(
                               title: Text('Não foi possivel adicionar'),
                             content: Text('Essa música ja se encontra na playlist'),
                               actions: [
                                  TextButton(
                            onPressed: () {
                        ...
                        showDialog(
                                 context: context,
                           builder: (_) => AlertDialog(
                               title: Text('PlayList Atualizada'),
                             content: Text('Musica adicionada com sucesso!'),
                               actions: [
                                  TextButton(
                            onPressed: () {
                                       Navigator.pop(context);
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              ...
              child: Text('Compartilhar Playlist'),
